...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "LexicalNodes_BEED8F5B".
 */
export type LexicalNodes_BEED8F5B =
  | SerializedTextNode
  | SerializedTabNode
  | SerializedLineBreakNode
  | SerializedParagraphNode<LexicalNodes_BEED8F5B>
  | SerializedAutoLinkNode<LexicalNodes_BEED8F5B, LexicalLinkFields>
  | SerializedLinkNode<LexicalNodes_BEED8F5B, LexicalLinkFields>
  | SerializedListNode<LexicalNodes_BEED8F5B>
  | SerializedListItemNode<LexicalNodes_BEED8F5B>
  | SerializedHeadingNode<LexicalNodes_BEED8F5B, 'h2' | 'h3'>;
...
export interface Config {
  ...
  collectionsSelect: {
    ...
    'support-reports': SupportReportsSelect<false> | SupportReportsSelect<true>;
  ...
  jobs: {
    tasks: {
      syncSupportReportStates: TaskSyncSupportReportStates;
      inline: {
        input: unknown;
        output: unknown;
      };
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "support-reports".
 */
export interface SupportReport {
  id: string;
  title: string;
  description: LexicalRichText<LexicalNodes_BEED8F5B>;
...
export interface PayloadJob {
  ...
  log?:
    | {
        executedAt: string;
        completedAt: string;
        taskSlug: 'inline' | 'syncSupportReportStates';
        taskID: string;
        input:
          | {
              [k: string]: unknown;
        ...
        error?:
          ...
          | null;
        parent?: {
          taskSlug?: ('inline' | 'syncSupportReportStates') | null;
          taskID?: string | null;
        };
        id?: string | null;
      }[]
...
export interface PayloadLockedDocument {
  ...
  document?:
    ...
    | ({
        relationTo: 'support-reports';
        value: string | SupportReport;
      } | null);
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "support-reports_select".
 */
export interface SupportReportsSelect<T extends boolean = true> {
  title?: T;
  description?: T;
  status?: T;
  externalId?: T;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "TaskSyncSupportReportStates".
 */
export interface TaskSyncSupportReportStates {
  input?: unknown;
  output: {
    checked?: number | null;
    updated?: number | null;
